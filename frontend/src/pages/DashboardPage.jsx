...
import {
  ...
  ListGroup,
  Image,
} from "react-bootstrap"; // Importar Image
              ...
              <div
                style={{
                  ...
                  backgroundImage: userProfile?.bannerUrl
                    ? `url(${process.env.REACT_APP_BACKEND_URL}${userProfile.bannerUrl})`
                    : "url(https://via.placeholder.com/800x150/3498db/ffffff?text=Tu+Banner+Aqui)",
                ...
                <Image
                  src={
                    userProfile?.profilePictureUrl
                      ? `${process.env.REACT_APP_BACKEND_URL}${userProfile.profilePictureUrl}`
                      : `https://via.placeholder.com/100/ecf0f1/2c3e50?text=${
