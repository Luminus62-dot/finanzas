      ...
      <Card className="mb-4 shadow-sm">
        <Card.Body>
          ...
          >
            <Row className="mb-3">
              {" "}
              {/* Eliminado 'g-3' del Row aquí, y lo pondremos en Col si es necesario */}
              <Col xs={12} md={6}>
                {" "}
                {/* xs={12} para ocupar todo el ancho en móviles, md={6} en medianas+ */}
                <Form.Group controlId="accountName" className="mb-3 mb-md-0">
                  {" "}
                  {/* mb-3 para móvil, mb-md-0 para med+ */}
          ...
          {accounts.length === 0 ? (
            ...
            <ListGroup variant="flush">
              {accounts.map((account) => (
                ...
                >
                  {" "}
                  {/* flex-column en móvil, flex-md-row en med+ */}
